...
import { X, Sparkles, Loader2, CheckCircle, AlertCircle, Image, Trash2, Edit3, Plus } from 'lucide-react'
import api from '@/api/client'
import { useBonoOlustur } from '@/hooks/useBonolar'
import { cn } from '@/lib/utils'

export default function BonoParseModal({ onKapat, onBasarili }) {
      ...
      <div className="flex max-h-[90vh] w-full max-w-5xl flex-col rounded-lg bg-card shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-input px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold">Bono ile Malzeme Ekle</h3>
          </div>
        ...
        {/* Footer */}
        {sonuc && (
          <div className="flex items-center justify-between border-t border-input px-5 py-4">
            <button
            ...
            <div className="flex gap-2">
              <button onClick={onKapat} className="rounded-lg border border-input px-4 py-2 text-sm font-medium hover:bg-muted">
                Iptal
              </button>
              <button
